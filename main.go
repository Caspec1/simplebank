...
import (
	...
	"github.com/Caspec1/simplebank/api"
	db "github.com/Caspec1/simplebank/db/sqlc"
	_ "github.com/Caspec1/simplebank/doc/statik"
	"github.com/Caspec1/simplebank/gapi"
...
func runGatewayServer(config util.Config, store db.Store) {
	...
	statikFS, err := fs.New()
	if err != nil {
		log.Fatal().Err(err).Msg("cannot create static file server:")
	}
	...
	hanlder := gapi.HttpLogger(mux)
	err = http.Serve(listener, hanlder)
	if err != nil {
