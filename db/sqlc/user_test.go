...
func createRandomUser(t *testing.T) User {
	...
	user, err := testQeries.CreateUser(context.Background(), arg)
	require.NoError(t, err)
...
func TestGetUser(t *testing.T) {
	...
	user2, err := testQeries.GetUser(context.Background(), user1.Username)
	require.NoError(t, err)
...
func TestUpdateUserOnlyFullName(t *testing.T) {
	...
	updatedUser, err := testQeries.UpdateUser(context.Background(), UpdateUserParams{
